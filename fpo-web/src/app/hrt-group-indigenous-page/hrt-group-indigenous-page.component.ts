...
@Component({
  selector: 'app-hrt-group-indigenous-page',
  templateUrl: './hrt-group-indigenous-page.component.html',
  styleUrls: ['./hrt-group-indigenous-page.component.scss']
})
export class HrtGroupIndigenousPageComponent implements OnInit, OnDestroy {
